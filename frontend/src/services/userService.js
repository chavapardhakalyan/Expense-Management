...
const createGoal = (userId, goalName, targetAmount, targetDate) => {
    return axios.post(
        API_BASE_URL + '/goal/create',
        {
            userId: userId,
            goalName: goalName,
...
const updateGoal = (goalId, goalName, targetAmount, targetDate) => {
    return axios.put(
        API_BASE_URL + '/goal/update',
        {
            goalName: goalName,
            targetAmount: targetAmount,
            targetDate: targetDate
